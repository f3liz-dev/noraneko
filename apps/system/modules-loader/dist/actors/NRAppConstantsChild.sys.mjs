//#region ../../modules/actors/NRAppConstantsChild.sys.mts
var NRAppConstantsChild = class extends JSWindowActorChild {
	actorCreated() {
		console.debug("NRAppConstantsChild created!");
		const window = this.contentWindow;
		if (window?.location.port === "5183") {
			console.debug("NRAppConstants 5183!");
			Cu.exportFunction(this.NRGetConstants.bind(this), window, { defineAs: "NRGetConstants" });
		}
	}
	NRGetConstants(callback = () => {}) {
